...
const fileName = "Email crawler.xlsx";
const filePath = "C:/Users/itsro/OneDrive/Desktop/Main REPO/Email web crawler/Emails-ExtractedData.xlsx";
    ...
    if (href && (href.startsWith("/") || href.startsWith(baseUrl))) {
      try {
        ...
        if (
          ...
          fullUrl.startsWith("https://www.facebook.com")
        ) {
          links.add(fullUrl);
        }
        //add base link
